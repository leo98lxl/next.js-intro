    ...
    <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      ...
      <h1 className="p-4 font-bold text-center">This is the Profile page.</h1>
        <div className="grid col-span-full gap-4 text-base font-medium sm:flex-row">
                  ...
                  <button className="p-4 text-cyan-500 hover:text-cyan-200 focus-visible:text-cyan-200 hover:cursor-pointer transition duration-150" type="submit">Search (WIP)</button>
                  </Form>
